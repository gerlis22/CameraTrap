...
![Figure1](images/Figure1.png){ width: 200px; }<br/>Figure 1. Time-lapse camera trap workflow. Data preparation and model steps are adapted from Böhner et al. (2022).
